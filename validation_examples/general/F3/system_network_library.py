...
#This file contains the implementation of the system network library. This library is being imported at each component's source code.
...
leader_address=("192.168.0.151",POLL_PORT)
					...
					if(singular==0):
						...
						for i in range(0,len(data_buffer)):
							if(data_buffer[i][0]==rcvmsg.get_src_components()):
								...
								print("Got a message from src component",rcvmsg.get_src_components(),"buffer size=",len(data_buffer[i]))
								break
					else:
						...
						for i in range(0,len(data_buffer)):
							if(data_buffer[i][0]==rcvmsg.get_src_components() and data_buffer[i][1]==rcvmsg.get_src_flow()):
								data_buffer[i].append(rcvmsg)
								print("Got a message from src component",rcvmsg.get_src_components(),"and src flow",rcvmsg.get_src_flow(),"buffer size=",len(data_buffer[i]))
								break
